    ...
    try {
      ...
      const sessionPromise = ai.live.connect({
        ...
        callbacks: {
          ...
          onerror: (e: any) => setStatus('SIGNAL_FAILURE'),
  ...
  return (
    <div className="h-full space-y-12 animate-in fade-in duration-700 pb-20">
      <div className="flex justify-between items-end">
        <div>
          <h2 className="text-4xl font-black text-white tracking-tighter uppercase italic leading-none">Neural_Intercept_Station</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-4 space-y-6 flex flex-col">
           <div className="bg-white/5 border border-white/10 rounded-[3rem] p-10 flex-1 backdrop-blur-3xl overflow-hidden flex flex-col relative shadow-3xl">
              ...
              <div className="flex-1 overflow-y-auto space-y-4 scrollbar-hide pr-2 text-slate-200">
                 {signals.length > 0 ? (
                   signals.map((s, i) => (
                     <div key={i} className="p-5 bg-white/[0.03] border border-white/5 rounded-2xl animate-in slide-in-from-right-4 duration-500">
                        <p className="text-[11px] font-medium leading-relaxed italic">"{s}"</p>
                   ...
                   <div className="h-full flex items-center justify-center opacity-20 italic text-sm text-center px-10">
