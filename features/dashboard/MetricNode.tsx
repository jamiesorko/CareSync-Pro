...
const MetricNode: React.FC<Props> = ({ label, value, icon: Icon, trend, trendType }) => (
  <div className="glass-card p-8 rounded-[2.5rem] hover:bg-white/[0.05] transition-all border border-white/5 shadow-2xl group flex flex-col justify-between overflow-hidden">
    ...
    <div className="space-y-1">
      ...
      <h4 className="text-4xl font-black text-white italic tracking-tighter uppercase leading-none mt-2">
